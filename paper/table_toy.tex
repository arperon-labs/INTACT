\begin{table}[t]
\centering
\caption{T-toy (hardened re-emit, 24 synthetic maps): all columns incl.\ certified-connected fractions (1b) and persistence cycles (1a). Toy $p$ is a blurred copy of the ground truth --- validation of the machinery, not evidence about real-model behaviour.}
\label{tab:toy}
\small
